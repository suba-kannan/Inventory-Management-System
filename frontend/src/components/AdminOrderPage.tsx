...
//   const handleEdit = (orderId: number, currentQuantity: number) => {
...
//                 {editingOrderId === order.id ? (
//                   <>
//                     <button onClick={() => handleSaveEdit(order.id)} className="save-button">Save</button>
//                     <button onClick={() => setEditingOrderId(null)} className="cancel-edit-button">Cancel</button>
//                   </>
//                 ) : (
//                   <>
//                     {order.status !== "cancelled" && (
//                       <>
//                         <button onClick={() => handleEdit(order.id, order.quantity)} className="edit-buttton">Edit Order</button>
//                         <button onClick={() => handleCancel(order.id)} className="cancel-order-button">Cancel Order</button>
//                       </>
//                     )}
//                   </>
//                 )}
...
//     try {
//       await axios.put(`http://localhost:5000/api/order/status/${orderId}`, {
//         status,
//       }, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
